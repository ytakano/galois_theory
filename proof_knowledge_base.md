...
- **Key Tactics**: `GroupIsomorphic_symm`, `fold N; fold M` (after simpl to restore set vars), `Z.mul_mod at 1`, `Zpow_mod_period_Z` (← direction), `Z.pow_add_r`, `ring`, `Z.gauss`, `Z.coprime_pow_l`, `five_pow_inj_mod`, `Z.mod_add`, `inj_hom_surj_of_eq_order`, `group_order_product`, `pow2_nm2_times2`, `injection Heq as Heq`
